...
import (
	...
	"github.com/OnenessLabs/genie/dkg/packages/shrinkingmap"
	"github.com/OnenessLabs/genie/dkg/packages/tcrypto"
	"github.com/OnenessLabs/genie/dkg/packages/util"
	"github.com/OnenessLabs/genie/dkg/packages/util/byz_quorum"
)
...
func (n *Node) GenerateDistributedKey(
	...
	// Step numbering (R) is according to <https://go.dedis.ch/kyber/blob/master/share/dkg/rabin/dkg.go>.
	if peerCount > 1 {
