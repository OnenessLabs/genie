...
import (
	...
	"github.com/OnenessLabs/genie/ethereum/crypto/signify"
	"github.com/OnenessLabs/genie/ethereum/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/OnenessLabs/genie/ethereum/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/OnenessLabs/genie/ethereum/internal/version.gitDate="+env.Date)
	}
	...
	*workdir = makeWorkdir(*workdir)
	...
	for _, pkg := range debPackages {
		for distro, goboot := range debDistroGoBoots {
			// Prepare the debian package with the ethereum sources.
...
type debMetadata struct {
	...
	// ethereum version being built. Note that this
