...
//
// Detailed usage document and tutorial available on the ethereum Wiki page:
// https://github.com/OnenessLabs/genie/ethereum/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
