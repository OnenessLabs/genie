...
// This test reproduces https://github.com/OnenessLabs/genie/ethereum/issues/17837 where the
...
// It is the reproducer for https://github.com/OnenessLabs/genie/ethereum/issues/22322
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("ethereum-test-ipc-%d-%d", os.Getpid(), rand.Int63())
